    ...
    class ArbolAVL
    {
        ...
        public Nodo buscar(Object buscado)
        {
            ...
            if (raiz == null)
                ...
                return buscar(raizArbol(), dato, 1);
        }
        protected Nodo buscar(Nodo raizSub, Comparador buscado, int contador)
        {
            if (raizSub == null)
                return null;
            else if (buscado.igualQue(raizSub.valorNodo(), contador))
                return raizSub;
            else if (buscado.menorQue(raizSub.valorNodo()))
                return buscar(raizSub.subarbolIzdo(), buscado, contador + 1);
            else
                return buscar(raizSub.subarbolDcho(), buscado, contador + 1);
        }
